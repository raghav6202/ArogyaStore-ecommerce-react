...
return( 
   ...
   <nav class="nav-bar">
        ...
        <div class="nav-logo-name">
            <img class="ecom-logo" src="images\Health people abstract logo (1).png" alt="logo image" />
        ...
        <div class="nav-components">
            ...
            <div class="carousel-container">
               ...
               <img class="carousel-img" src="https://images.pexels.com/photos/5910956/pexels-photo-5910956.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940" alt="image" >
            ...
            <section class="ecomm-categories">
                ...
                <div class="category-cards shadow">
                    ...
                    <div class="category-img"><img class="horizontal-card-image"
                        src="https://images.pexels.com/photos/3683088/pexels-photo-3683088.jpeg?auto=compress&cs=tinysrgb&dpr=2&w=500"
                        alt="category image" />
                   </div>

                    <div class="category-info">

                        <div class="category-heading carousel-heading">Medicenes</div>

                        <div class="card-text">
                            Get Medicenes at affordable prices.<strong>Shop Now and get discounts upto 20%</strong>
                        </div>
                ...
                <div class="category-cards shadow">
                    <div class="category-img"><img class="horizontal-card-image"
                        src="https://images.pexels.com/photos/8442443/pexels-photo-8442443.jpeg?auto=compress&cs=tinysrgb&dpr=2&w=500"
                        alt="category image" />
                  </div>
                    ...
                    <div class="category-info">
                        ...
                        <div class="category-heading">Tests</div>

                        <div class="card-text">
                            Diagnostic tests done at youe doorstep.<strong>Book Now and get discounts upto 30%</strong>
                        </div>
                ...
                <div class="category-cards shadow">
                    <div class="category-img"><img class="horizontal-card-image"
                        src="https://images.pexels.com/photos/6753425/pexels-photo-6753425.jpeg?cs=srgb&dl=pexels-pavel-danilyuk-6753425.jpg&fm=jpg"
                    ...
                    <div class="category-info">
                        ...
                        <div class="category-heading">Med-Tech</div>

                        <div class="card-text">
                            Get premium quality health monitoring devices.<strong>Book Now and get discounts upto 30%</strong>
                        </div>
                ...
                <div class="category-cards shadow">
                    ...
                    <div class="category-img"><img class="horizontal-card-image"
                        src="https://images.pexels.com/photos/8795582/pexels-photo-8795582.jpeg?auto=compress&cs=tinysrgb&dpr=2&w=500"
                        alt="category image" />
                   </div>
                    ...
                    <div class="category-info">
                        ...
                        <div class="category-heading">Rehab</div>
